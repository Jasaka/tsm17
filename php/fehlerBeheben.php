...
<body id="page-top" class="index">
    ...
    <section>
		...
		if(!$nutzerDaten->fehlerVorhanden()){
			if($nutzerDaten->datenUpdatenMitKennung($kennung)){
				header("Location: ../fehlerBehoben.html");
			} else {
				print("<section>
		<div class='container'>
	        <div class='row text-center'>
	            <div class='col-lg-offset-1 col-lg-10 col-xs-10 col-xs-offset-1 box nay'>
	                <h3>Es ist ein Datenbankfehler aufgetreten.</h3>
	                <p>Es tut uns leid, dass grade jetzt passiert.</p>
